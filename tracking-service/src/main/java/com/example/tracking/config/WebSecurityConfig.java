...
import com.example.tracking.security.RestAuthenticationEntryPoint;
import com.example.tracking.security.TokenAuthenticationFilter;
import com.example.tracking.utils.TokenUtils;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) {
        web.ignoring().antMatchers(HttpMethod.GET , "/coordinates");
    }
}
