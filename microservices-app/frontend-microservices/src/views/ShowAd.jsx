...
this.setState({hideForm:false, canEdit:true})
  ...
  componentDidMount() {
    ...
    axios({
      ...
      this.setState({cjenovnik:response.data.pricelist, cjenovnikId: response.data.pricelist.id, kilometraza:response.data.carAd.mileage, maxKilometraza:response.data.carAd.mileageLimit, city:response.data.city, cjenovnikId:response.data.pricelist.id, brSjedista:response.data.carAd.kidsSeats})
    ...
    let ret = (
      ...
      <div>
        <Row hidden = {this.state.izbrisan}>
                ...
                <div>
                  ...
                  <Row>
                    ...
                    <MDBCardTitle tag="h6"> Day price: <p style={{ color: "red" }}>{this.state.cjenovnik.priceDay} RSD</p> </MDBCardTitle>
                      ...
                      <MDBCardTitle tag="h6"> Created by: <p style={{ color: "red" }}>{this.state.oglas.name}-{this.state.oglas.username}   </p></MDBCardTitle>
                    </Col>
          ...
          {localStorage.getItem('role') == "ROLE_SELLER" && <Col hidden ={this.state.canEdit} className="mb-3 mb-xl-0">
            <Row>
